...
public class ProductionResponse {
    ...
    public ProductionResponse(UUID growthId, String slotType, UUID slotId, String inputItemCode, String outputItemCode, long outputQuantity, OffsetDateTime startedAt, OffsetDateTime readyAt, String status) {
